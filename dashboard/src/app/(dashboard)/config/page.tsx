  ...
  return (
    <div className="flex items-center justify-between py-2.5 border-b border-border/40 last:border-0">
      ...
      <div className="flex items-center gap-2">
        {badge}
        <span className="text-[12px] font-mono tabular-nums font-semibold">{value}</span>
      </div>
    </div>
  );
}
        ...
        {config && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
            <Card>
              ...
              <CardContent>
                <Row
                  label="Run Mode" value={config.mode}
                  badge={<Badge variant={config.mode === "paper" ? "info" : config.mode === "live" ? "profit" : "muted"}>{config.mode}</Badge>}
                />
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Row
                  label="Partial TP" value={config.partial_tp_enabled ? "Enabled" : "Disabled"}
            ...
            <Card>
              ...
              <CardContent>
                <Row label="Max Hold Time" value={`${Math.floor(config.max_hold_secs / 60)}m`} />
